 ...
 *
 * @property Page $page
 * @property HomeSliderTranslation[] $translations
 */
...
//            [['page_id'], 'exist', 'skipOnError' => true, 'targetClass' => Page::className(), 'targetAttribute' => ['page_id' => 'id']],
    ...
    public function behaviors() {
        ...
        return[
            [
                ...
                'translatedAttributes'=>['title', 'text']
            ],
            [
                'class' => \backend\components\UploadImageBehavior::className(),
                'attributes' => ['image'],
                'scenarios' => ['insert', 'update'],
                'path' => '@frontend/web/media/home-slider/{id}',
                'url' => "$baseurl/media/home-slider/{id}",                
                'unlinkOnDelete'=>true,
                'thumbs' => [
    ...
    {
        return $this->hasMany(HomeSliderTranslation::className(), ['slide_id' => 'id']);
    }
